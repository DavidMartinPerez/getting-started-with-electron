...
const INITIAL_STATE = {
  tasks: [
    { id: 1, task: "Prueba 1", totalTime: 10 },
    { id: 2, task: "Prueba 2", totalTime: 60 },
    { id: 3, task: "Prueba 3", totalTime: 1000 },
    { id: 4, task: "Prueba 4", totalTime: 10000 },
    { id: 5, task: "Prueba 5", totalTime: 100000 }
  ],
  activeTask: null,
  timer: {
    active: false,
